...
\centering
\includegraphics[width=5cm]{implicit-surfaces}
\caption{Curvature of the determinant $\curvature$ diverging as saddle-node bifurcations emerge from a smooth steady state manifold}
\label{fig:diverging-curvature}
\end{figure}
